...
Status: fechada em 2026-09-22 — porquê promovido a docs/adr/README.md (o índice de sistema, com os ADRs 0001–0007 desta fase), apps/api/docs/adr/README.md (0103, 0104, 0156, 0157, 0158, 0196–0202), CLAUDE.md (fluxo de branches, geografia de guias e regras transversais), docs/guides/deploy.md + apps/api/docs/guides/deploy.md + apps/web/docs/guides/deploy.md (o procedimento: o stack na raiz, o recorte de cada app no app) e docs/todo.md (o resultado destilado). A tabela de rastreio decisão → destino está em .scratch/fase-11-monorepo/issues/13-phase-close.md.
