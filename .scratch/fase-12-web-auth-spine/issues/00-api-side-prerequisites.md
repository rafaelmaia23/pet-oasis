...
- [x] As duas fechadas: o `typecheck` do web passa importando a tabela de rotas e a view de
      ...
      tabela nasceu na issue 17 da Fase 11 (`packages/api-contracts/src/routes/`), e o
      `typecheck` do web foi verificado contra ela lá (2026-09-22). A fiação permanente do web
      é da issue 12 da Fase 11.
