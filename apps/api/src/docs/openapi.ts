...
**Projeto de portfólio, aberto e documentado.** O *porquê* de cada decisão vive no [repositório no GitHub](https://github.com/rafaelmaia23/pet-oasis) — README e um ADR por decisão, com o raciocínio longo.
