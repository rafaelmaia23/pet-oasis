...
dependência** — config pura, consumida por `workspace:*`. Foram os primeiros pacotes internos do
...
API refletir) para provar que o `extends` está vivo e não silenciosamente ignorado.
