...
Status: fechada em 2026-09-22 — porquê promovido a docs/adr/README.md (docs/adr/0005-monorepo-in-place-pnpm-turborepo.md, docs/adr/0006-one-source-for-node-pnpm-and-one-version-per-dependency.md, docs/adr/0007-single-compose-stack-one-image-per-app.md, docs/adr/0003-route-table-is-contract-openapi-is-derived.md, docs/adr/0004-feature-names-cross-the-wire-as-enum.md, docs/adr/0001-domain-docs-follow-the-skill.md, docs/adr/0002-tracker-folders-are-phases.md), apps/api/docs/adr/README.md (0103, 0104, 0156, 0157, 0158, 0196–0202), CLAUDE.md (fluxo de branches e regras transversais), docs/guides/deploy.md + apps/api/docs/guides/deploy.md + apps/web/docs/guides/deploy.md (o procedimento: o stack na raiz, o recorte de cada app no app) e docs/todo.md (o resultado destilado). A tabela de rastreio decisão → destino está em .scratch/fase-11-monorepo/issues/13-phase-close.md.
