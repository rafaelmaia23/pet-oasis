...
> Status de conta com verificação de email obrigatória, serviço de email genérico (nodemailer; mailpit em dev / Resend em prod), recuperação/troca de senha e banimento. Regras e racional em `apps/api/docs/adr/README.md#identidade-e-sessões`.
...
> `.scratch/monorepo/`.
- Progresso: 6 de 14 issues fechadas (01–05 e 07).
