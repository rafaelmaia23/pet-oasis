...
A reserva perpétua nasceu na 7.15 com um argumento só: "mesmo idioma do email preso de usuário
...
que a criou. Passa a valer só o email **atual** de um `User` (inclusive deletado), que o `@unique` de
